...
class OutputLayoutTest(unittest.TestCase):
    ...
    def test_atomic_publication_and_routing(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.write(staging, "spieceasi/network_topology_summary.tsv")
            self.write(staging, "spieceasi/network_topology_null_draws.tsv")
            self.write(staging, "three_tier_decontam/ASV_final_three_tier.tsv")
            self.write(staging, "three_tier_decontam/three_tier_results/filtered/filter_summary.txt")
            ...
            self.assertTrue((output / "modules/network_analysis/tables/network_topology_summary.tsv").exists())
            self.assertTrue((output / "modules/network_analysis/tables/network_topology_null_draws.tsv").exists())
            self.assertTrue((output / "modules/contamination_filtering/tables/ASV_final_three_tier.tsv").exists())
            self.assertTrue((output / "modules/contamination_filtering/tables/three_tier_results/filtered/filter_summary.txt").exists())
