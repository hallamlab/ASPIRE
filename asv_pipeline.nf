...
workflow optional {
    ...
    metaMicroForMeasurementAssociation = metadata_micro.map { it }
    metaMicroForGroupingDiagnostics = metadata_micro.map { it }
    ...
    if( asvMagNetworkEnabled ) {
        ...
        asv_mag_network_stage = ASV_MAG_NETWORK(
